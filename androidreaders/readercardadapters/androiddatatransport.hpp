...
namespace logicalaccess
{
    ...
    public:
         ...
         */
        virtual std::string getTransportType() const { return "AndroidDataTransport"; };
        ...
        {
            boost::property_tree::ptree node;	parentNode.add_child(getDefaultXmlNodeName(), node);
        }
         ...
         */
        virtual std::string getDefaultXmlNodeName() const { return "AndroidDataTransport"; };
        ...
        virtual std::string getName() const { return "Android"; };
