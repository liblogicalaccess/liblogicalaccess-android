...
class LIBLOGICALACCESS_API AndroidReaderProvider : public ReaderProvider
{
  public:
    /**
     * \brief Get the STidSTReaderProvider instance. Singleton because we can only
     * have one COM communication, and Deister can't have shared access, so we
     * share the same reader unit.
     */
